package mx.gob.sedena.persistance;
...
public class DatabaseBackend extends net.sqlcipher.database.SQLiteOpenHelper {


    private static DatabaseBackend instance = null;


    public static String PASSFRASE = XmppConnectionService.PASSFRASE; //contrasena
    ...
    public DatabaseBackend(Context context) {
        ...
        //if (PASSFRASE == null) {
          //  this.PASSFRASE = XmppConnectionService.PASSFRASE;
        //}
    ...
    public void onCreate(SQLiteDatabase db) {
        PASSFRASE = XmppActivity.PASSFRASE;
    ...
    public void createConversation(Conversation conversation) {
        SQLiteDatabase db = this.getWritableDatabase(PASSFRASE);
    ...
    public ServiceDiscoveryResult findDiscoveryResult(final String hash, final String ver) {
        SQLiteDatabase db = this.getReadableDatabase(PASSFRASE);
        ...
        return new Iterable<Message>() {
            ...
            public Iterator<Message> iterator() {
                class MessageIterator implements Iterator<Message> {
                    SQLiteDatabase db = getReadableDatabase(PASSFRASE);
                    String[] selectionArgs = {conversation.getUuid()};
    ...
    public void updateConversation(final Conversation conversation) {
        final SQLiteDatabase db = this.getWritableDatabase(PASSFRASE);
    ...
    @Override
    public SQLiteDatabase getWritableDatabase(String a) {
        SQLiteDatabase db = super.getWritableDatabase(PASSFRASE);
        db.execSQL("PRAGMA foreign_keys=ON;");
        return db;
    }
    ...
    public long getLastTimeFingerprintUsed(Account account, String fingerprint) {
        ...
        Cursor cursor = getReadableDatabase(PASSFRASE).rawQuery(SQL, args);
        long time;
    ...
    private Cursor getCursorForSession(Account account, AxolotlAddress contact) {
        final SQLiteDatabase db = this.getReadableDatabase(PASSFRASE);
        String[] selectionArgs = {account.getUuid(),
                contact.getName(),
    ...
    public long numTrustedKeys(Account account, String name) {
        ...
        //				+ " AND " +SQLiteAxolotlStore.ACTIVE + " > 0", args);
    }
    ...
    public SQLiteDatabase contactos() {
        SQLiteDatabase db = this.getWritableDatabase(PASSFRASE);

        db.execSQL("select jid from contacts");
